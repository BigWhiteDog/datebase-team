...
typedef struct
{
	...
	//char table_name[128];
//need to translate the table_name into table_no
	int select_table_all_col;//1 for select *
	int select_table_no[MAX_COL_NUM];//0 for tab0 , 1 for tab1 ,
	int select_table_col_no[MAX_COL_NUM];
